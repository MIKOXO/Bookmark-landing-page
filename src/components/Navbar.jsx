    ...
    <header className="mx-auto container px-6 py-4 mt-8">
      <nav className="flex flex-row items-center justify-between">
        ...
        <div className="sm:hidden flex">
          ...
          <div
            className={clsx(
              "fixed top-0 left-0 w-full h-full pt-10 opacity-95 bg-Blue950 text-white flex flex-col items-center space-y-8 uppercase tracking-widest transition-transform duration-300 ease-in-out",
