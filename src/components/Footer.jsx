...
const Footer = () => {
  return (
    <section className="bg-Blue950 p-8 lg:py-16">
      <div className="mx-auto container px-6 flex flex-col lg:flex-row items-center justify-between text-center">
        <div className="flex flex-col sm:flex-row items-center gap-10">
          ...
          <ul className="lg:ml-10 flex flex-col sm:flex-row items-center gap-12 uppercase text-Grey50 text-opacity-70 tracking-widest">
            <li>
              <a
                href="#"
                className="hover:text-Red400 ease-in-out duration-300"
              >
                Features
              </a>
            </li>
        ...
        <div className="flex flex-row items-center gap-10 mt-10 lg:mt-0">
          <a href="#">
            <img
              src={LogoFacebook}
              alt="Facebook Logo"
              className="h-6 hover:opacity-50 ease-in-out duration-300"
            />
          </a>
          <a href="#">
            <img
